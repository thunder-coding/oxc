...
- `no-implicit-globals` - 241 / 245 (98.4%)
...
AssertionError [ERR_ASSERTION]: Should have 3 errors but had 2: [
  {
    ruleId: 'rule-to-test/no-redeclare',
    message: "'a' is already defined by a variable declaration.",
